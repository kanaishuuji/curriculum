...
public class Task1_4 {
    ...
    private static final String namae = "alice";
    private static final String kagi ="pass";
    // 定数（メッセージ）
    ...
    public static void main(String[] args) {
        ...
        if (namae.equals(name)&&(kagi.equals(pass))) {
            System.out.println(CONST_MSG_SUCCESS);
        } else if (namae.equals(name)&& !(kagi.equals(pass))){
             System.out.println(CONST_MSG_ERROR_PASS);
        } else if (kagi.equals(pass)&& !(namae.equals(name))){
